...
if __name__ == "__main__":
    ...
    # Build a search term
    search = {"db": avail[0], "md5": md5_val}  # pick the first search term
    ...
    print(
        "Now we will do a query for multiple MD5 values. You can do this by specifying\n"
        + "a value as an array."
    )
    searchm = {
        "db": avail[0],
        "md5": ["EB714443AA2FC1A3D16E39EB8007A0B2", "9B3702B0E788C6D62996392FE3C9786A"],
    }
