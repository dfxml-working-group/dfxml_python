class histogram(dict):
    ...
    def make_graph(
        ...
        if horizontal:
            ...
            rects = plot.barh(
                bottom=np.arange(numbins) + 1.5 * barHeight / 2,
                width=counts,
                height=barHeight,
                align="center",
            )
            ...
            rects = plot.bar(
                left=np.arange(numbins) + 1.5 * barHeight / 2,
                height=counts,
                width=barHeight,
                align="center",
            )
...
if __name__ == "__main__":
    ...
    j.make_graph(
        saveas="histogram_demo1", reverse=False, sortValues=True, horizontal=True
    )
    j.print_info(1000)
